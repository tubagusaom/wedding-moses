...
<div class="row">
  ...
  <div class="col-md-9">
    <ol class="breadcrumb">
        ...
        <li class="active">Media Publikasi</li>
      </ol>
      <div class="col-lg-12">
          <div class="col-lg-8"><img class="img-thumbnail" src="<?=base_url().'assets/files/artikel/'.$berita_lsp->foto;?>"></div>
          <div class="col-lg-4"> 
      ...
      <div class="col-lg-3">
            ...
            <p style="text-align:center; margin-top:20px;">
              <img width="250" height="220" src="<?=base_url().'assets/files/artikel/'.$berita_lsp2->foto;?>" alt="">
            </p>
            <div class="caption">
              <div class="blur"></div>
              <div class="caption-text">
                <h3 style="border-top:2px solid white; border-bottom:2px solid white; padding:10px;">Berita LSP</h3>
                <p><?=$berita_lsp2->judul?></p>
                <a class=" btn btn-default" href="<?=base_url().'profile/index/'.$berita_lsp2->id?>"><span class="glyphicon glyphicon-plus"> Detail</span></a>
              </div>
            </div>
          </div>
      ...
      <div class="col-lg-3">
            <div class="cuadro_intro_hover " style="background-color:#cccccc;">
            <p style="text-align:center; margin-top:20px;">
              <img width="250" height="220" src="<?=base_url().'assets/files/artikel/'.$berita_bnsp->foto;?>" alt="">
            </p>
            <div class="caption">
              <div class="blur"></div>
              <div class="caption-text">
                <h3 style="border-top:2px solid white; border-bottom:2px solid white; padding:10px;">Berita BNSP</h3>
