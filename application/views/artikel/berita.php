...
<div class='container-fluid'>
  <div class='row'>
    <nav class='col-xs-12'>
      <div class='newsnav'>
        <div id='recentnews'><i class="fa fa-newspaper-o"></i><span class='hidden-xxs'>Artikel <?=$aplikasi->nama_unit?></span></div>
      </div>
    </nav>
  </div>
  ...
  <div class='row'>
    <div class="col-xs-12">
    <!--STYLE1-->
    <?php foreach ($berita_lsp_list as $key => $value) { ?>
    <a href='<?=base_url()."profile/index/".$value->id?>' class='col-md-3'>
      <article class='style1'>
        <div class='date'>  ARTIKEL </div>
        <!--must have larger width than height-->
        <i class="loader fa fa-spinner"></i>
        <img class='lazy' data-original='<?=base_url().'assets/files/artikel/'.$value->foto?>' alt="<?=$aplikasi->nama_unit?>">
        <div class='content'>
          <!--32 charecter max-->
          <div class='title'>
