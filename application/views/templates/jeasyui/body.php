...
<div class="easyui-layout" data-options="fit:'true'">
			...
			<div data-options="region:'east', border: false" style="width: 70%;background-color: #fff;">
				<div style="float: right; margin: 10px;">
					...
					<div id="mm1" style="width:150px;">
						<div id="role-btn">Akses: <?php echo $rolename ?></div>
	...
	<div data-options="region:'south',split:true" style="height:50px;">
		<div class="x-form-copyright" style="bottom: 10px;"> &copy;2019 <?=$aplikasi->singkatan_unit?>, Developed By <a href="https://www.instagram.com/tera_byt3_/" target="_blank">تبغس اوم</a> </div>
	</div>
