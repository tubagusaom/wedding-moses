...
switch ($extension) {
    case "pdf":
        echo '<object type="application/pdf" data="' . base_url('assets/files/member/' . $nmfile) . '" width="100%" height="600" style="height: 85vh;">File Not Found / File No Support</object>';
        die();
        break;
    default:
        ?>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        var CanvasCrop = $.CanvasCrop({
            cropBox: ".imageBox",
            imgSrc: base_url + "assets/files/member/" + $("#idImg").val(),
            limitOver: 2
        });
