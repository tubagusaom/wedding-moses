    ...
    function proses($id = false) {
        ...
        $con_method = $this->Pesan_Model->get(intval($id));
            if (sizeof($con_method) == 1) {
                ...
                $footer = '<br/><span id="yui_3_16_0_ym19_1_1469402382195_8369" style="color:rgb(7,55,99);">LSP SMK 3 KUNINGAN</span></b></font><br></span></div><div id="yui_3_16_0_ym19_1_1469402382195_8367"><span style="font-family:georgia, serif;"><br></span></div><span style="font-family:georgia, serif;"></span></div><span id="yui_3_16_0_ym19_1_1469402382195_8365" style="font-family:georgia, serif;"><span id="yui_3_16_0_ym19_1_1469402382195_8364" style="color:rgb(0,0,0);">Website : <span style="color:rgb(0,0,255);"><a rel="nofollow" target="_blank" href="http://www.lsp.p2kgk-jakpus.org">www.lsp.p2kgk-jakpus.org</a></span></span></span><br><span id="yui_3_16_0_ym19_1_1469402382195_8358" style="font-family:georgia, serif;"><span id="yui_3_16_0_ym19_1_1469402382195_8357" style="color:rgb(0,0,0);"><span id="yui_3_16_0_ym19_1_1469402382195_8362"><span id="yui_3_16_0_ym19_1_1469402382195_8361" style="font-family:georgia, serif;"><span id="yui_3_16_0_ym19_1_1469402382195_8360" style="color:rgb(0,0,0);">E-mail :&nbsp;&nbsp;</span></span><span id="yui_3_16_0_ym19_1_1469402382195_8376" style="color:rgb(0,0,255);"><u id="yui_3_16_0_ym19_1_1469402382195_8375"><a id="yui_3_16_0_ym19_1_1469402382195_8374" rel="nofollow" ymailto="mailto:lspp2kgk@gmail.com" target="_blank" href="mailto:lspp2kgk@gmail.com">lspp2kgk@gmail.com</a><br></u></span></span>Contact Person : +6285329489247</span>';
                $pesan = $header.$pesan.$footer;
                //var_dump($pesan);die();
        ...
        $query= $querys->row();
            if (count($query) == 1) {
                ...
                $this->db->where('id',$query->reciepent_id);
                $users = $this->db->get('t_users')->row();
                ...
                if (valid_email($users->email))
                {
                    ...
                    $this->email->subject($query->title);
                    //$pesan = $query->message;
