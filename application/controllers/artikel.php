...
class Artikel extends MY_Controller {
    ...
    {
        $data['value'] = $this->Artikel_Model->detail($id);
    ...
    function category($id=false){
        if($id==false){
            $data['data'] = $this->db->get(kode_tbl().'artikel_kategori')->result();
            $data['aplikasi'] = $this->db->get('r_konfigurasi_aplikasi')->row();
            $this->load->view('templates/bootstraps/header',$data);
            $this->load->view('artikel/vcategory',$data);
            $this->load->view('templates/bootstraps/bottom');
        }else{
            $data['data'] = $this->Artikel_Model->category($id);
            $data['aplikasi'] = $this->db->get('r_konfigurasi_aplikasi')->row();
            $this->load->view('templates/bootstraps/header',$data);
            $this->load->view('artikel/vcategory_article',$data);
            $this->load->view('templates/bootstraps/bottom');
        }
